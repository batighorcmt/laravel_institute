...
Route::prefix('v1')->group(function () {
    ...
    Route::get('principal/reports/lesson-evaluations/meta', [\App\Http\Controllers\Api\PrincipalReportController::class, 'lessonEvaluationMeta'])->middleware('role:principal');
    ...
    Route::get('principal/reports/teachers', [\App\Http\Controllers\Api\PrincipalReportController::class, 'getTeachers'])->middleware('role:principal');
