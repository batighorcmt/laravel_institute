...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'throttle:120,1', 'active_school'])->group(function () {
            ...
            Route::get('principal/reports/lesson-evaluations/student/{studentId}', [\App\Http\Controllers\Api\PrincipalReportController::class , 'lessonEvaluationStudentProfile'])->middleware('role:principal');
