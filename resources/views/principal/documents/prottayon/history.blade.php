      ...
      <tbody>
        @forelse($records as $rec)
          <tr>
            ...
            <td>
              <a class="btn btn-sm btn-outline-secondary" target="_blank" href="{{ route('principal.institute.documents.prottayon.print', [$school, $rec->id]) }}">Print</a>
              <a class="btn btn-sm btn-outline-primary" href="{{ route('principal.institute.documents.prottayon.edit', [$school, $rec->id]) }}">Edit</a>
            </td>
          </tr>
        @empty
