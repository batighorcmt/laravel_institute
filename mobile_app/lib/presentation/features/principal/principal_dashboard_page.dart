          ...
          children: [
            ...
            Builder(
              builder: (ctx) {
                ...
                final selfStatus =
                    _selfRecord?['status']?.toString() ?? 'Absent';
                final checkIn =
                    _selfRecord?['check_in_time']?.toString() ?? '-';
                final checkOut =
                    _selfRecord?['check_out_time']?.toString() ?? '-';
                ...
                AnimatedTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const TeacherExamsPage(), // Principal has full access
                      ),
                    );
                  },
                ),
