...
<head>
    ...
    <title>সকল শিক্ষার্থীর মাসিক রিপোর্ট কার্ড — {{ $team->name }}</title>
...
<div class="no-print">
    <button onclick="window.print()">
        <i class="fas fa-print" style="margin-right:6px;"></i> সকল রিপোর্ট কার্ড একসাথে প্রিন্ট করুন
    </button>
</div>
...
@empty
<div style="text-align: center; padding: 50px; background: #fff; margin: 50px auto; max-width: 500px; border-radius: 8px;">
    <h3>টিমে কোনো শিক্ষার্থী পাওয়া যায়নি।</h3>
</div>
@endforelse
