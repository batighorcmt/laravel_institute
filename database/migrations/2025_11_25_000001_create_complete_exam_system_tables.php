...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('seat_plan_classes')) {
        ...
        if (!Schema::hasTable('seat_plan_exams')) {
        ...
        if (!Schema::hasTable('seat_plan_rooms')) {
        ...
        if (!Schema::hasTable('seat_plan_allocations')) {
        ...
        if (!Schema::hasTable('subject_group_map')) {
