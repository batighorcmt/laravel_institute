        ...
        <div class="row mt-2">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="board_registration_no" class="form-control" value="{{ old('board_registration_no', $student->board_registration_no) }}" placeholder="বোর্ড রেজিস্ট্রেশন নম্বর লিখুন (ঐচ্ছিক)">
            </div>
          </div>
        </div>
      </div>
