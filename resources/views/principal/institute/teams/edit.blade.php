...
@section('title','দল সম্পাদনা')
@section('content')
<div class="d-flex justify-content-between mb-3">
  <h1 class="m-0">দল সম্পাদনা</h1>
...
<form method="post" action="{{ route('principal.institute.teams.update',[$school,$team]) }}">@csrf @method('PUT')
  ...
  <button class="btn btn-success"><i class="fas fa-save mr-1"></i> আপডেট</button>
</form>
@endsection