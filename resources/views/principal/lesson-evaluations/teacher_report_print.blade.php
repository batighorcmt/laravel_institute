    ...
    <table>
        <thead class="bg-light">
            <tr class="text-center">
                ...
                <th class="text-left align-middle" rowspan="2">{{ $t['class_section'] }}</th>
        ...
        <tbody>
            ...
            @foreach($reportData as $index => $row)
                ...
                <tr class="text-center">
                    ...
                    <td class="text-left" style="font-weight: bold;">{{ $row['class_name'] }} [{{ $row['section_name'] }}]</td>
