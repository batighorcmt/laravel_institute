                    ...
                    <div class="row" id="result_publish_date_wrapper" style="display:none;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="result_publish_date" id="result_publish_date" class="form-control @error('result_publish_date') is-invalid @enderror" value="{{ old('result_publish_date', $exam->result_publish_date ? $exam->result_publish_date->format('Y-m-d') : '') }}">
