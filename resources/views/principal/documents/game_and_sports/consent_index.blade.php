...
@section('title', 'অভিভাবকের সম্মতিপত্র - গেম এন্ড স্পোর্টস')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark font-weight-bold"><i class="fas fa-running mr-2 text-primary"></i> অভিভাবকের সম্মতিপত্র</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('principal.dashboard') }}">ড্যাশবোর্ড</a></li>
                    <li class="breadcrumb-item active">Game and Sports</li>
                    <li class="breadcrumb-item active">Parental Consent</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8">
                <div class="card card-primary card-outline shadow-lg border-0">
                    ...
                    <div class="card-body p-4">
                        <form id="consentForm" action="{{ route('principal.institute.game-and-sports.consent.print', $school) }}" target="_blank">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label class="font-weight-bold text-muted small uppercase mb-1">শিক্ষাবর্ষ <span class="text-danger">*</span></label>
                                        <select name="academic_year_id" id="academic_year_id" class="form-control select2bs4" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label class="font-weight-bold text-muted small uppercase mb-1">শ্রেণি <span class="text-danger">*</span></label>
                                        <select name="class_id" id="class_id" class="form-control select2bs4" required>
                                            <option value="">-- নির্বাচন করুন --</option>
                                            @foreach($classes as $class)
                                                <option value="{{ $class->id }}">{{ $class->bangla_name ?: $class->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label class="font-weight-bold text-muted small uppercase mb-1">শাখা (ঐচ্ছিক)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label class="font-weight-bold text-muted small uppercase mb-1">খেলার ইভেন্ট <span class="text-danger">*</span></label>
                                        <select name="game_name" id="game_name" class="form-control select2bs4" required>
                                            <option value="">-- নির্বাচন করুন --</option>
                            ...
                            <div class="form-group mb-4">
                                <label class="font-weight-bold text-muted small uppercase mb-1">শিক্ষার্থী (রোল - নাম) <span class="text-danger">*</span></label>
                                <select name="student_id" id="student_id" class="form-control select2bs4" required disabled>
                ...
                <div class="alert alert-info border-0 shadow-sm mt-4">
                    ...
                    <p class="mb-0">
                        সঠিক শিক্ষার্থী এবং খেলার নাম নির্বাচন করে প্রিন্ট বাটনে ক্লিক করলে অভিভাবকের পূর্ণাঙ্গ সম্মতিপত্র প্রদর্শিত হবে। এটি প্রিন্ট করে অভিভাবকের স্বাক্ষর গ্রহণ করতে পারবেন।
                    </p>
                </div>
            </div>
        </div>
...
<style>
    .select2-container--bootstrap4 .select2-selection--single { height: calc(2.25rem + 10px) !important; padding-top: 8px !important; border-radius: 8px !important; }
    .select2-container--bootstrap4 .select2-selection--single .select2-selection__arrow { top: 12px !important; }
