...
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
  <h1 class="m-0"><i class="fas fa-print mr-1"></i> শিক্ষক রুটিন প্রিন্ট</h1>
  <div>
    @if(request()->routeIs('principal.*'))
      <a href="{{ route('principal.institute.routine.teacher-panel', $school) }}" class="btn btn-secondary">ফিরে যান</a>
    @else
...
<div class="card">
  <div class="card-body">
    ...
    @if($maxPeriod <= 0 || empty($activeDays) || empty($activePeriods))
      <div class="alert alert-warning">এই শিক্ষকের জন্য কোনো ক্লাস নির্ধারিত নেই।</div>
    @else
