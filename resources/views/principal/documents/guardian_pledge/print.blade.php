    ...
    <div class="pledge-page">
        ...
        <div class="body-content">
            <p class="pledge-text text-indent">
                আমি এই মর্মে অঙ্গীকার করছি যে, আমি <span class="text-fill">{{ $guardianName }}</span>। আমার সন্তান <span class="text-fill">{{ $student->student_name_bn ?: $student->student_name_en }}</span> {{ $schoolName }}-এর {{ $yearBn }} সালের {{ $className }} শ্রেণির অর্ধ-বার্ষিক ও বার্ষিক পরীক্ষায় অংশগ্রহণ করবে। আমি তার উক্ত পরীক্ষাসমূহে অংশগ্রহণকল্পে আমার সন্তান ও বিদ্যালয় কর্তৃপক্ষকে সর্বোচ্চ সহযোগিতা করব। এর পরেও যদি আমার সন্তান অর্ধ-বার্ষিক ও বার্ষিক পরীক্ষায় কৃতকার্য না হয় তাহলে তাকে পরবর্তী শ্রেণিতে উন্নীত করার জন্য আমি কোনক্রমেই অত্র প্রতিষ্ঠান কর্তৃপক্ষকে অনুরোধ বা সুপারিশ করব না এবং আমি স্বেচ্ছায় আমার সন্তানকে একই শ্রেণিতে পুনরায় পাঠদানের করাব।
            </p>
            <p class="pledge-text">
