<template>
  <div>
    ...
    <nav class="sticky top-0 z-50 bg-[#0f172a]/95 backdrop-blur-md shadow-2xl">
      <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row w-full items-center md:justify-between gap-2">
        <div class="w-full md:flex-1 md:min-w-0 flex justify-start">
          <frontend-site-nav
        ...
        <div v-if="showAdmissionCta && school.code" class="py-2 shrink-0 md:ml-auto">
